...
<head>
  ...
  <script>
     function onSubmit(token) {
       document.getElementById("registerInterest").submit();
     }
   </script>
</head>
...
<body class="leading-normal tracking-normal text-gray-900" style="font-family: 'Space Mono', monospace; background-color: #FDEFEF;">
    ...
    <div class="w-full container mx-auto p-8">
      <div class="w-full flex items-center justify-between">
        ...
        <div class="flex w-1/2 justify-end content-center">   
          <a href="https://www.instagram.com/ivyworks.store/" target="_blank">
            <svg class="inline-block text-center p-2 h-10 md:h-16 md:p-4" style="color: #1E212D;" 
    ...
    <!--Main-->
    <div class="container pt-8 md:pt-0 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      
      @yield('content')

      <!--Footer-->
      <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
        <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; IVY WORKS {{ date('Y') }}</a>
      </div>
    </div>
  </div>
</body>

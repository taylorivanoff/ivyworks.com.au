      ...
      <section class="w-full flex flex-wrap flex-col md:flex-row items-center ">
        ...
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          <h1 class="mt-5 mb-12 text-3xl md:text-5xl font-bold leading-tight text-left slide-in-bottom-h1" style="color:#1E212D">
            INTRODUCING THE<br>SENSE MACROPAD SERIES.
          </h1>

          <p class="leading-normal text-base mb-8 text-left slide-in-bottom-subtitle">
            A series of plug-and-play USB-C macropads by IVY WORKS featuring mechanical key switches.
            <br><br>
          ...
          <p class="leading-normal text-base mb-8 text-left slide-in-bottom-subtitle">Available in 6%, 8%, 12% and 16% variations on Etsy.</p>
